...
var Sbox34_12_2008 = Sbox([8][16]uint8{
...
func sbox(n bh) bh {
	return bh(Sbox34_12_2008[0][(n>>0)&0x0F])<<0 +
		bh(Sbox34_12_2008[1][(n>>4)&0x0F])<<4 +
		bh(Sbox34_12_2008[2][(n>>8)&0x0F])<<8 +
		bh(Sbox34_12_2008[3][(n>>12)&0x0F])<<12 +
		bh(Sbox34_12_2008[4][(n>>16)&0x0F])<<16 +
		bh(Sbox34_12_2008[5][(n>>20)&0x0F])<<20 +
		bh(Sbox34_12_2008[6][(n>>24)&0x0F])<<24 +
		bh(Sbox34_12_2008[7][(n>>28)&0x0F])<<28
}
